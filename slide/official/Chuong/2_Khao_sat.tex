...
Use case Quản lý thành viên và thanh toán bao gồm hai nhánh: đăng ký gói nền tảng hệ thống và đang ký gọi hội viên theo artist. Đăng ký nền tảng hệ thống phục vụ các quyền lợi chung của người dùng, còn hội viên phục vụ quan hệ trả phí giữa người sáng tạo và người hâm mộ.
...
\subsection{Đặc tả use case Kiểm duyệt báo cáo và gửi khiếu nại}
...
\hline
\textbf{Tiền điều kiện} & Có tác phẩm bị báo cáo, bị hệ thống đánh dấu hoặc được người sáng tạo gửi khiểu nại; quản trị viên đã đăng nhập và có quyền xử lý. \\
\hline
