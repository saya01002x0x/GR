...
Ba nền tảng chia sẻ ảnh và nghệ thuật số nổi bật trên thị trường hiện nay là Pinterest, DeviantArt và Patreon. Đây là những nền tảng lớn, có lượng người dùng đông đảo và nhiều chức năng phong phú, là cơ sở quan trọng để so sánh, phân tích và đề xuất cho hệ thống cần phát triển.

\subsubsection*{Pinterest}
Địa chỉ truy cập: \url{https://www.pinterest.com}

Pinterest là nền tảng mạng xã hội hình ảnh phổ thông, nơi trọng tâm là khám phá nội dung và tương tác nhanh.
\begin{itemize}
  \item \textbf{Ưu điểm:}
  \begin{itemize}
    \item Tương tác nhanh, dễ tiếp cận, phù hợp khám phá nội dung mới.
    \item Tốc độ lan truyền nội dung hình ảnh rất cao.
  \end{itemize}
  \item \textbf{Nhược điểm:}
  \begin{itemize}
    \item Tìm kiếm nghệ thuật chuyên sâu chưa tốt.
    \item Khó kiểm soát nội dung theo quy trình riêng của cộng đồng sáng tạo đặc thù như truyện tranh.
  \end{itemize}
\end{itemize}

\subsubsection*{DeviantArt}
Địa chỉ truy cập: \url{https://www.deviantart.com}

DeviantArt là cộng đồng nghệ thuật số lâu đời, tập trung nhiều vào hồ sơ nghệ sĩ và bộ sưu tập tác phẩm.
\begin{itemize}
  \item \textbf{Ưu điểm:}
  \begin{itemize}
    \item Không gian phù hợp cho người sáng tạo với hồ sơ nghệ sĩ chuyên nghiệp.
    \item Hệ thống tag, album tác phẩm và phân loại phong cách đa dạng.
  \end{itemize}
  \item \textbf{Nhược điểm:}
  \begin{itemize}
    \item Khả năng tìm kiếm phụ thuộc nhiều vào tag và mô tả do người đăng nhập thủ công.
    \item Chưa nhấn mạnh xử lý nền tự động và phát hiện ảnh trùng lặp triệt để.
  \end{itemize}
\end{itemize}

\subsubsection*{Patreon}
Địa chỉ truy cập: \url{https://www.patreon.com}

Patreon là nền tảng hỗ trợ người sáng tạo kiếm tiền thông qua quan hệ trả phí với người hâm mộ.
\begin{itemize}
  \item \textbf{Ưu điểm:}
  \begin{itemize}
    \item Hỗ trợ người sáng tạo thiết lập gói hội viên linh hoạt.
    \item Cung cấp giải pháp nhận doanh thu trực tiếp từ người hâm mộ.
  \end{itemize}
  \item \textbf{Nhược điểm:}
  \begin{itemize}
    \item Tách rời khỏi nền tảng khám phá ảnh, khiến người dùng phải chuyển đổi ứng dụng.
    \item Quyền truy cập nội dung độc quyền thường phải đồng bộ thủ công giữa nơi trưng bày tác phẩm và nơi thanh toán.
  \end{itemize}
\end{itemize}

\subsection{Các chức năng cần có cho hệ thống}
\label{subsection:2.1.2}
Mặc dù mỗi nền tảng có định hướng khác nhau, chúng đều giải quyết một phần của bài toán mà đồ án hướng tới. Hệ thống đề xuất trong đồ án sẽ giải quyết các hạn chế bằng cách tích hợp trực tiếp cơ chế chia sẻ ảnh, xử lý nền, kiểm duyệt nội dung, tìm kiếm lai và quản lý hội viên trên cùng một nền tảng. Bảng \ref{table:2_1} trình bày tóm tắt các tính năng cốt lõi cần có cho hệ thống để đạt được mục tiêu này.

\begin{table}[h!]
    \caption{Tóm tắt các tính năng cốt lõi cần thiết cho hệ thống đề xuất}
    \label{table:2_1}
\centering
\small
...
\hline
\textbf{Nhóm tính năng} & \textbf{Mô tả chi tiết} \\
\hline
Tài khoản và phân quyền & Đăng nhập, đồng bộ hồ sơ, quản lý trạng thái nghệ sĩ, kiểm soát quyền quản trị viên. \\
\hline
Quản lý tác phẩm & Đăng tải ảnh, tạo ảnh thu nhỏ, ảnh làm mờ, đóng dấu bản quyền, kiểm duyệt ảnh nhạy cảm và phát hiện ảnh trùng lặp bằng mã băm nhận thức. \\
\hline
Tìm kiếm và khám phá & Tìm kiếm từ khóa, lọc theo tag, tỷ lệ ảnh, tìm kiếm ngữ nghĩa, gợi ý tác phẩm liên quan. \\
\hline
Tương tác cộng đồng & Thích, bình luận, đánh dấu tác phẩm, tạo bộ sưu tập, theo dõi nghệ sĩ. \\
\hline
Hội viên và thanh toán & Thiết lập hạng gói hội viên, đăng ký trả phí định kỳ, giới hạn quyền xem tác phẩm theo gói hội viên, quản lý doanh thu. \\
\hline
Kiểm duyệt và quản trị & Báo cáo vi phạm, duyệt hoặc từ chối tác phẩm, khóa tài khoản, nhật ký hệ thống. \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
Hệ thống được phân tích theo phương pháp hướng đối tượng với các tác nhân chính và các use case mức cao. Mục tiêu của phần này là mô tả tổng quan phạm vi chức năng, chưa đi vào luồng chi tiết của từng use case. Các use case quan trọng sẽ được đặc tả trong phần \ref{section:2.3}.

\subsection{Biểu đồ use case tổng quát}
\label{subsection:2.2.1}

Hệ thống có bốn nhóm tác nhân chính. Khách là người chưa đăng nhập, có thể xem nội dung công khai, tìm kiếm, xem trang tác phẩm và trang nghệ sĩ trong phạm vi cho phép. Người dùng là người đã đăng nhập, có thể tương tác với tác phẩm, quản lý bộ sưu tập, theo dõi nghệ sĩ, báo cáo vi phạm và đăng ký các gói thành viên. Người sáng tạo là người dùng có thêm khả năng đăng tải và quản lý tác phẩm, thiết lập gói hội viên, xem người đăng ký và theo dõi doanh thu. Quản trị viên hoặc điều phối viên là nhóm có quyền xử lý báo cáo, kiểm duyệt tác phẩm, quản lý người dùng, quản lý cấu hình hệ thống và theo dõi thống kê vận hành.

Hình \ref{fig:2_1} trình bày biểu đồ use case tổng quát của hệ thống.
\begin{figure}[h!]
\centering
...
Các use case mức cao của hệ thống gồm: quản lý tài khoản, quản lý tác phẩm, tìm kiếm và khám phá nội dung, tương tác cộng đồng, quản lý thành viên và thanh toán, kiểm duyệt và quản trị. Nhóm quản lý tài khoản bao phủ đăng nhập, đồng bộ hồ sơ, cập nhật thông tin cá nhân và trở thành người sáng tạo. Nhóm quản lý tác phẩm bao phủ đăng tải, xử lý ảnh, chỉnh sửa, xem trạng thái và quản lý quyền truy cập theo tier. Nhóm tìm kiếm và khám phá bao phủ tìm kiếm toàn văn, lọc, sắp xếp, tìm kiếm ngữ nghĩa, tìm kiếm bằng phác thảo và gợi ý nội dung. Nhóm tương tác cộng đồng bao phủ thích, bình luận, lưu vào bộ sưu tập, theo dõi và báo cáo vi phạm. Nhóm thành viên và thanh toán bao phủ gói nền tảng, gói hội viên của hoạ sĩ, đăng ký, hủy đăng ký, lịch sử thanh toán, doanh thu và thanh toán. Nhóm kiểm duyệt và quản trị bao phủ xử lý báo cáo, duyệt hoặc từ chối tác phẩm, quản lý người dùng, nhật ký hoạt động hệ thống và thống kê.

\subsection{Biểu đồ use case phân rã Quản lý tài khoản}
\label{subsection:2.2.2}

Use case Quản lý tài khoản liên quan đến cả người dùng thường và người sáng tạo. Hệ thống sử dụng Clerk cho xác thực, nhưng vẫn duy trì hồ sơ người dùng nội bộ để lưu vai trò, trạng thái artist, trạng thái bị khóa, thông tin thanh toán Stripe và các quan hệ xã hội. Khi người dùng đăng nhập lần đầu, backend thực hiện đồng bộ lười, tạo hoặc cập nhật bản ghi người dùng dựa trên định danh Clerk.

Hình \ref{fig:2_2} trình bày biểu đồ use case phân rã của nhóm chức năng Quản lý tài khoản.
\begin{figure}[h!]
\centering
...
Các use case con gồm đăng nhập, xem hồ sơ cá nhân, cập nhật hồ sơ, mở trang thiết lập bảo mật của Clerk, trở thành người sáng tạo, xem bảng điều khiển cá nhân và kiểm tra trạng thái tài khoản. Đối với người dùng bị khóa, middleware phía frontend gọi backend để kiểm tra trạng thái và chuyển hướng người dùng sang trang thông báo chặn nếu cần.

\subsection{Biểu đồ use case phân rã Quản lý tác phẩm}
\label{subsection:2.2.3}

Use case Quản lý tác phẩm là trung tâm của hệ thống. Người sáng tạo có thể đăng tải một tác phẩm gồm một hoặc nhiều ảnh, nhập tiêu đề, mô tả, tag, chọn chế độ hiển thị, chọn hạng hội viên yêu cầu nếu là nội dung giới hạn, cấu hình watermark và theo dõi trạng thái xử lý. Sau khi tạo tác phẩm, hệ thống đưa tác phẩm vào hàng đợi để worker xử lý ảnh bất đồng bộ.

Hình \ref{fig:2_3} trình bày biểu đồ use case phân rã của nhóm chức năng Quản lý tác phẩm.
\begin{figure}[h!]
\centering
...
Các use case con gồm tạo tác phẩm, tải ảnh lên, cấu hình watermark, chọn quyền truy cập, gửi xử lý nền, xem tiến độ xử lý, xem tác phẩm đã xuất bản, chỉnh sửa thông tin, quảng bá tác phẩm, xem tác phẩm liên quan và gửi khiếu nại khi tác phẩm bị đưa vào trạng thái cần xử lý. Hệ thống phân biệt trạng thái tác phẩm như đang xử lý, đã xuất bản, thất bại, cần xử lý và đang được xem xét lại. Thiết kế này phù hợp với thực tế xử lý ảnh vì kiểm duyệt và phát hiện trùng lặp có thể xảy ra ở từng ảnh trong cùng một tác phẩm.
...
Hình \ref{fig:2_4} trình bày biểu đồ use case phân rã của nhóm chức năng Tìm kiếm và khám phá nội dung.
\begin{figure}[h!]
\centering
...
Hình \ref{fig:2_5} trình bày biểu đồ use case phân rã của nhóm chức năng Tương tác cộng đồng.
\begin{figure}[h!]
\centering
...
Các use case con gồm thích hoặc bỏ thích tác phẩm, bình luận, xóa bình luận của bản thân, lưu tác phẩm vào bộ sưu tập, tạo bộ sưu tập, thêm hoặc xóa tác phẩm khỏi bộ sưu tập, theo dõi hoặc bỏ theo dõi nghệ sĩ, xem bảng tin theo dõi, báo cáo tác phẩm vi phạm và nhận thông báo. Một số tương tác như lượt xem hoặc lượt thích cũng được dùng để cập nhật thống kê và đồng bộ sang chỉ mục tìm kiếm.

\subsection{Biểu đồ use case phân rã Quản lý thành viên và thanh toán}
\label{subsection:2.2.6}

Use case Quản lý thành viên và thanh toán bao gồm hai nhánh: đăng ký gói nền tảng hệ thống và đăng ký gói hội viên theo artist. Đăng ký nền tảng hệ thống phục vụ các quyền lợi chung của người dùng, còn hội viên phục vụ quan hệ trả phí giữa người sáng tạo và người hâm mộ.

Hình \ref{fig:2_6} trình bày biểu đồ use case phân rã của nhóm chức năng Quản lý thành viên và thanh toán.
\begin{figure}[h!]
\centering
...
Các use case con gồm xem danh sách gói hội viên, tạo phiên thanh toán, đồng bộ kết quả hoàn tất thanh toán, mở cổng thông tin khách hàng, hủy thanh toán, tạo gói hội viên, cập nhật gói hội viên, lưu trữ gói hội viên, xem danh sách người đăng ký tier, đăng ký các hạng gói hội viên của artist, hủy đăng ký gói hội viên, xem lịch sử thanh toán, xem doanh thu và tạo yêu cầu rút tiền. Hệ thống tích hợp cổng thanh toán (Stripe) để xử lý thanh toán và webhook để đồng bộ trạng thái về cơ sở dữ liệu nội bộ.
...
Hình \ref{fig:2_7} trình bày biểu đồ use case phân rã của nhóm chức năng Kiểm duyệt và quản trị.
\begin{figure}[h!]
\centering
...
Các use case con gồm xem danh sách tác phẩm bị đánh dấu, xem báo cáo vi phạm của tác phẩm, duyệt tác phẩm, từ chối tác phẩm, xử lý yêu cầu xem xét lại, xem lịch sử báo cáo đã giải quyết, cảnh báo người dùng, khóa hoặc mở khóa người dùng, thay đổi vai trò người dùng, xem thống kê, cấu hình trọng số xếp hạng, cấu hình tìm kiếm khám phá, xem nhật ký hệ thống, quản lý nhân sự điều phối và xử lý yêu cầu rút tiền. Hệ thống cần đảm bảo chỉ người có vai trò phù hợp mới truy cập được các chức năng này.
...
Hình \ref{fig:2_8} mô tả luồng xử lý chi tiết của quy trình đăng tải và xử lý tác phẩm.
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{Hinh_2_8_Quy_trinh_dang_tai_xu_ly_anh.png}
\caption{Quy trình nghiệp vụ đăng tải và xử lý tác phẩm}
\label{fig:2_8}
\end{figure}
\FloatBarrier

Mô tả sơ bộ quy trình như sau. Người sáng tạo đăng nhập và truy cập trang tải lên. Sau khi nhập thông tin tác phẩm và chọn ảnh, frontend gửi yêu cầu tạo tác phẩm tới backend. Backend lưu metadata, lưu tệp tạm vào hệ thống lưu trữ, tạo job xử lý ảnh và trả về mã job cho frontend theo dõi. Worker nhận job, tải từng ảnh, tính pHash để phát hiện trùng lặp, phân loại NSFW, tạo ảnh gốc tối ưu, ảnh xem trước, ảnh thu nhỏ và ảnh làm mờ. Nếu ảnh hợp lệ, thông tin ảnh được lưu với trạng thái thành công; nếu ảnh trùng lặp hoặc nhạy cảm, hệ thống lưu metadata lỗi ở cấp ảnh. Khi tất cả ảnh đã được xử lý, nếu không có lỗi, tác phẩm được xuất bản và lập chỉ mục tìm kiếm; nếu có lỗi, tác phẩm chuyển sang trạng thái cần xử lý để người sáng tạo hoặc quản trị viên xem xét.

Quy trình nghiệp vụ thứ hai là quy trình đăng ký gói hội viên. Quy trình này kết hợp các use case xem hạng gói hội viên công khai, tạo phiên thanh toán, thanh toán qua cổng thanh toán, webhook đồng bộ đăng ký và kiểm tra quyền truy cập nội dung giới hạn.

Hình \ref{fig:2_9} mô tả luồng xử lý chi tiết của quy trình đăng ký gói thành viên.
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{Hinh_2_9_Quy_trinh_thanh_vien_tier.png}
\caption{Quy trình nghiệp vụ đăng ký gói thành viên của người sáng tạo}
\label{fig:2_9}
\end{figure}
\FloatBarrier

Người dùng truy cập trang nghệ sĩ và xem các hạng gói hội viên đang hoạt động. Khi chọn đăng ký một gói hội viên, backend kiểm tra người dùng, đảm bảo khách hàng trên cổng thanh toán tồn tại và tạo phiên thanh toán. Sau khi người dùng thanh toán, cổng thanh toán gửi webhook về backend. Backend xác minh chữ ký webhook, đọc metadata của đăng ký, cập nhật bảng đăng ký gói hội viên và ghi nhận thanh toán. Từ thời điểm gói hội viên đăng ký ở trạng thái hoạt động, người dùng được phép truy cập các tác phẩm đặt quyền truy cập theo tier tương ứng.
...
Bảng \ref{table:2_2} mô tả chi tiết đặc tả use case Đăng nhập và đồng bộ tài khoản.
\begin{table}[h!]
...
Bảng \ref{table:2_3} mô tả chi tiết đặc tả use case Đăng tải tác phẩm.
\begin{table}[h!]
...
\hline
\textbf{Luồng sự kiện chính} &
1. Người sáng tạo truy cập trang tải lên. \newline
...
Bảng \ref{table:2_4} mô tả chi tiết đặc tả use case Tìm kiếm và khám phá tác phẩm.
\begin{table}[h!]
...
Bảng \ref{table:2_5} mô tả chi tiết đặc tả use case Tương tác với tác phẩm.
\begin{table}[h!]
...
3. Người dùng chọn một hành động tương tác: thích, bình luận, lưu vào bộ sưu tập hoặc theo dõi tác giả. \newline
...
\textbf{Báo cáo vi phạm:} Người dùng chọn lý do, gửi mô tả; hệ thống tạo báo cáo để quản trị viên xử lý. \newline
...
\hline
\textbf{Hậu điều kiện} & Tương tác được ghi nhận; bộ đếm và trạng thái giao diện được cập nhật; nếu có báo cáo, báo cáo được đưa vào hàng xử lý kiểm duyệt. \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
Bảng \ref{table:2_6} mô tả chi tiết đặc tả use case Đăng ký gói thành viên của người sáng tạo.
\begin{table}[h!]
...
\hline
\textbf{Luồng sự kiện chính} &
1. Người dùng truy cập trang nghệ sĩ hoặc trang hội viên. \newline
...
8. Backend xác minh webhook và đồng bộ trạng thái gói hội viên. \newline
9. Hệ thống cho phép người dùng truy cập nội dung giới hạn theo tier đã đăng ký. \\
\hline
\textbf{Luồng sự kiện thay thế} &
\textbf{Người dùng hủy thanh toán:} Cổng thanh toán chuyển người dùng về trang hủy, gói hội viên không được kích hoạt. \newline
...
\textbf{Gói hội viên quá hạn hoặc bị hủy:} Người dùng mất quyền truy cập nội dung giới hạn sau khi hệ thống đồng bộ trạng thái. \\
\hline
\textbf{Hậu điều kiện} & Nếu thanh toán thành công, gói hội viên nội bộ ở trạng thái hoạt động và quyền truy cập nội dung giới hạn được mở cho người dùng. \\
\hline
\end{tabular}
\end{table}
\FloatBarrier

\subsection{Đặc tả use case Kiểm duyệt báo cáo và Khiếu nại}
\label{subsection:2.3.6}

Bảng \ref{table:2_7} mô tả chi tiết đặc tả use case Kiểm duyệt báo cáo và Khiếu nại.
\begin{table}[h!]
    \caption{Đặc tả use case Kiểm duyệt báo cáo và Khiếu nại}
    \label{table:2_7}
\centering
\small
\renewcommand{\arraystretch}{1.2}
...
\hline
\textbf{Tên Use Case} & Kiểm duyệt báo cáo và gửi khiếu nại \\
\hline
\textbf{Tác nhân} & Người dùng, Người sáng tạo, Moderator, Admin \\
\hline
\textbf{Tiền điều kiện} & Có tác phẩm bị báo cáo, bị hệ thống đánh dấu hoặc được người sáng tạo gửi khiếu nại; quản trị viên đã đăng nhập và có quyền xử lý. \\
\hline
\textbf{Tóm tắt} & Điều phối viên xem xét báo cáo hoặc khiếu nại, sau đó duyệt, từ chối, cảnh báo hoặc áp dụng biện pháp xử lý đối với tác phẩm và người dùng liên quan. \\
\hline
\textbf{Luồng sự kiện chính} &
1. Moderator hoặc Admin truy cập trang kiểm duyệt. \newline
2. Hệ thống hiển thị danh sách tác phẩm bị đánh dấu hoặc báo cáo đang chờ xử lý. \newline
3. Điều phối viên mở chi tiết tác phẩm, xem ảnh, metadata lỗi, pHash liên quan, báo cáo và lịch sử xử lý. \newline
4. Điều phối viên đưa ra quyết định duyệt hoặc từ chối. \newline
5. Backend cập nhật trạng thái tác phẩm và trạng thái báo cáo. \newline
6. Nếu cần, backend tạo cảnh báo cho người dùng hoặc cập nhật trạng thái khóa tài khoản. \newline
7. Hệ thống ghi nhật ký hệ thống cho thao tác quản trị. \newline
8. Người sáng tạo hoặc người báo cáo nhận được kết quả xử lý qua giao diện hoặc thông báo. \\
\hline
\textbf{Luồng sự kiện thay thế} &
\textbf{Người sáng tạo gửi khiếu nại:} Nếu tác phẩm ở trạng thái cần xử lý, hệ thống chuyển tác phẩm sang trạng thái đang xem xét lại. \newline
\textbf{Bằng chứng chưa đủ:} Điều phối viên có thể giữ báo cáo ở trạng thái chờ xử lý hoặc yêu cầu thông tin bổ sung. \newline
...
\hline
\textbf{Hậu điều kiện} & Báo cáo được cập nhật trạng thái; tác phẩm được duyệt, từ chối hoặc tiếp tục chờ xử lý; thao tác quản trị được ghi nhận trong audit log. \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
\textbf{Yêu cầu về hiệu năng.} Các API phục vụ thao tác đọc phổ biến như xem danh sách tác phẩm, tìm kiếm, xem chi tiết tác phẩm và xem hồ sơ nghệ sĩ cần có thời gian phản hồi ngắn trong điều kiện tải thông thường. Các tác vụ nặng như thay đổi kích thước ảnh, tạo thumbnail, kiểm duyệt NSFW, phát hiện trùng lặp và sinh embedding không được thực hiện trực tiếp trong request chính mà phải chuyển sang hàng đợi nền. Tìm kiếm toàn văn cần sử dụng chỉ mục Meilisearch; tìm kiếm ngữ nghĩa cần sử dụng cột vector và cache truy vấn khi phù hợp. Bộ đếm lượt xem và cập nhật thống kê cần được kiểm soát tần suất hoặc gom lô để tránh ghi cơ sở dữ liệu quá dày.

\textbf{Yêu cầu về độ tin cậy.} Hệ thống phải lưu được trạng thái trung gian của tác phẩm trong quá trình xử lý, ví dụ đang xử lý, đã xuất bản, thất bại, cần xử lý hoặc đang xem xét lại. Nếu một ảnh trong tác phẩm bị lỗi, hệ thống cần lưu lỗi ở cấp ảnh thay vì làm mất toàn bộ dữ liệu tác phẩm. Worker cần ghi log lỗi rõ ràng, cập nhật tiến độ và đảm bảo cơ sở dữ liệu không rơi vào trạng thái mâu thuẫn. Các sự kiện thanh toán phải được đồng bộ qua webhook đã xác minh chữ ký, không chỉ dựa vào lệnh chuyển hướng từ frontend.

\textbf{Yêu cầu về bảo mật và phân quyền.} Các API yêu cầu đăng nhập phải được bảo vệ bằng cơ chế xác thực token. Các API quản trị phải kiểm tra vai trò như Moderator, Admin hoặc Super Admin. Người dùng chỉ được chỉnh sửa tác phẩm của chính mình, chỉ được xem nội dung giới hạn khi có gói hội viên phù hợp và chỉ được thao tác với bộ sưu tập của bản thân. Các webhook thanh toán phải được xác minh bằng chữ ký. Hệ thống cần lưu audit log cho các thao tác quản trị quan trọng như duyệt tác phẩm, từ chối tác phẩm, khóa người dùng, đổi vai trò và xử lý yêu cầu rút tiền.

\textbf{Yêu cầu về tính dễ dùng.} Giao diện tải lên cần hiển thị rõ trạng thái xử lý để người sáng tạo biết tác phẩm đang ở bước nào. Khi ảnh bị đánh dấu NSFW hoặc trùng lặp, hệ thống cần cung cấp lý do đủ rõ để người dùng có thể sửa hoặc gửi khiếu nại. Trang tìm kiếm cần cho phép kết hợp từ khóa, tag, bộ lọc và sắp xếp. Trang gói hội viên cần trình bày rõ giá, quyền lợi và trạng thái đăng ký. Trang quản trị cần ưu tiên khả năng quét nhanh danh sách báo cáo, tác phẩm bị đánh dấu và lịch sử xử lý.

\textbf{Yêu cầu về khả năng bảo trì.} Mã nguồn backend cần được chia theo module nghiệp vụ như xác thực, người dùng, tác phẩm, tìm kiếm, hàng đợi, thanh toán, kiểm duyệt và quản trị. Các tích hợp bên ngoài như Cổng thanh toán, Clerk, Meilisearch, Redis và storage cần được đóng gói trong service riêng để giảm phụ thuộc trực tiếp. Cơ sở dữ liệu cần được mô hình hóa rõ quan hệ giữa người dùng, tác phẩm, ảnh, tag, gói hội viên và báo cáo. Những logic có khả năng thay đổi như ngưỡng NSFW, trọng số xếp hạng hoặc giới hạn tìm kiếm nên được đặt trong cấu hình hoặc bảng thiết lập hệ thống.

\textbf{Yêu cầu về khả năng mở rộng.} Kiến trúc modular monolith cần cho phép mở rộng theo chiều ngang ở những điểm có tải cao, đặc biệt là worker xử lý ảnh và dịch vụ tìm kiếm. Redis và BullMQ cần hỗ trợ nhiều worker tiêu thụ cùng một hàng đợi khi số lượng ảnh tăng. Hệ thống tìm kiếm cần có cơ chế đồng bộ lại chỉ mục khi Meilisearch bị lệch so với cơ sở dữ liệu. Cơ chế tìm kiếm vector ban đầu có thể đặt trong PostgreSQL với pgvector; khi dữ liệu tăng rất lớn, hệ thống cần có khả năng tách sang hạ tầng vector search chuyên dụng mà không làm thay đổi quá nhiều giao diện người dùng.

\textbf{Yêu cầu về dữ liệu và lưu trữ.} Cơ sở dữ liệu PostgreSQL là nguồn dữ liệu chính cho thông tin người dùng, tác phẩm, tương tác, báo cáo, thanh toán và cấu hình. File ảnh cần được lưu ở storage riêng; cơ sở dữ liệu chỉ lưu URL, metadata và trạng thái xử lý. Với mỗi ảnh, hệ thống cần lưu được URL bản gốc, bản xem trước, thumbnail, ảnh làm mờ, pHash, embedding và metadata lỗi nếu có. Dữ liệu thanh toán cần lưu đủ để đối soát, nhưng không lưu thông tin thẻ nhạy cảm vì phần này do cổng thanh toán quản lý.

\textbf{Yêu cầu về khả năng quan sát.} Hệ thống cần cung cấp nhật ký log cho các lỗi xử lý ảnh, lỗi đồng bộ Meilisearch, lỗi webhook thanh toán, lỗi xác thực và lỗi truy vấn AI search. Các thao tác quản trị phải có audit log. Các chỉ số như số lượng tác phẩm, người dùng, báo cáo, lượt xem, lượt thích, doanh thu và payout cần được tổng hợp để hỗ trợ trang tổng quan quản trị.

Tóm lại, chương này đã khảo sát các nhóm hệ thống tương tự, phân tích các hạn chế còn tồn tại và xác định các nhóm chức năng cần thiết cho nền tảng chia sẻ ảnh trực tuyến. Chương này cũng đã xây dựng use case tổng quát, phân rã các use case mức cao, mô tả hai quy trình nghiệp vụ quan trọng và đặc tả sáu use case tiêu biểu. Các yêu cầu phi chức năng được tổng hợp ở cuối chương sẽ là căn cứ để thiết kế kiến trúc, thiết kế cơ sở dữ liệu và triển khai hệ thống trong các chương tiếp theo.
